...
import vip.untitled.bungeesafeguard.commands.subcommands.list.*
...
open class ListCommand(
    ...
    name: String, permission: String, vararg aliases: String): ConfirmCommand(name, permission, *aliases) {
    protected val subcommands: MutableList<Base> = mutableListOf(
        ...
        AddCommand(context, "x-add", client, listMgr, list, true, "xadd"),
        LazyAddCommand(context, "lazy-add", client, listMgr, list, "lazyadd", "ladd"),
        RemoveCommand(context, "remove", client, listMgr, list, false, "rm"),
        RemoveCommand(context, "x-remove", client, listMgr, list, true, "xremove", "x-rm", "xrm"),
        LazyRemoveCommand(context, "lazy-remove", client, listMgr, list, "lazyremove", "lremove", "lrm"),
        OnCommand(context, "on", client, listMgr, list),
        OffCommand(context, "off", client, listMgr, list),
        DumpCommand(context, "list", client, listMgr, list, "ls", "show", "dump")
    )
    @Suppress("MemberVisibilityCanBePrivate")
